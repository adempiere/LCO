...
jar cf $ADEMPIERE_INSTALL/packages_LCO$ADEMPIERE_VERSION_FILE.jar -C $BUILD_DIR .

ls -l $ADEMPIERE_INSTALL/packages_LCO$ADEMPIERE_VERSION_FILE.jar

cp $ADEMPIERE_INSTALL/packages_LCO$ADEMPIERE_VERSION_FILE.jar $ADEMPIERE_ROOT/packages/LCO/lib/packages_LCO.jar
