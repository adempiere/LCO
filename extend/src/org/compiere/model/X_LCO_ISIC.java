 ...
 *  @version Release 3.2.0 - $Id: X_LCO_ISIC.java,v 1.3 2007/05/09 10:43:45 cruiz Exp $ */
public class X_LCO_ISIC extends PO
{
/** Standard Constructor
@param ctx context
@param LCO_ISIC_ID id
...
/** AD_Table_ID=1000004 */
public static final int Table_ID=MTable.getTable_ID("LCO_ISIC");

/** TableName=LCO_ISIC */
public static final String Table_Name="LCO_ISIC";

protected static KeyNamePair Model = new KeyNamePair(Table_ID,"LCO_ISIC");
...
{
StringBuffer sb = new StringBuffer ("X_LCO_ISIC[").append(get_ID()).append("]");
return sb.toString();
}
/** Set Description.
...
{
if (LCO_ISIC_ID < 1) throw new IllegalArgumentException ("LCO_ISIC_ID is mandatory.");
set_ValueNoCheck ("LCO_ISIC_ID", Integer.valueOf(LCO_ISIC_ID));
}
/** Get ISIC.
@return ISIC */
