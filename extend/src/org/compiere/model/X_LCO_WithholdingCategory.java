 ...
 *  @version Release 3.2.0 - $Id: X_LCO_WithholdingCategory.java,v 1.3 2007/05/09 10:43:46 cruiz Exp $ */
public class X_LCO_WithholdingCategory extends PO
{
/** Standard Constructor
@param ctx context
@param LCO_WithholdingCategory_ID id
...
/** AD_Table_ID=1000005 */
public static final int Table_ID=MTable.getTable_ID("LCO_WithholdingCategory");

/** TableName=LCO_WithholdingCategory */
public static final String Table_Name="LCO_WithholdingCategory";

protected static KeyNamePair Model = new KeyNamePair(Table_ID,"LCO_WithholdingCategory");
...
{
StringBuffer sb = new StringBuffer ("X_LCO_WithholdingCategory[").append(get_ID()).append("]");
return sb.toString();
}
/** Set Description.
...
{
if (LCO_WithholdingCategory_ID < 1) throw new IllegalArgumentException ("LCO_WithholdingCategory_ID is mandatory.");
set_ValueNoCheck ("LCO_WithholdingCategory_ID", Integer.valueOf(LCO_WithholdingCategory_ID));
}
